...
import { Mail, Phone, Linkedin, Send, CheckCircle2, AlertCircle, Loader2, Clock, MessageCircle } from 'lucide-react';
...
// Set to true when email backend / API configuration details are ready
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
            {SHOW_EMAIL_FORM
              ...
              : "Interested in Revenue Growth Management consulting, advisory, commercial analytics leadership, or collaborations? Reach out directly via email, phone, or LinkedIn."}
          </p>
        </div>

        {!SHOW_EMAIL_FORM ? (
          /* Centered Direct Contact Cards when Form is Hidden */
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Email Card */}
              <a
                href={`mailto:${PERSONAL_INFO.email}`}
                className="flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 shadow-sm hover:border-blue-500/50 hover:shadow-md transition-all group"
                id="contact-card-email"
              >
                <div className="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-blue-950 flex items-center justify-center text-blue-600 dark:text-blue-400 mb-4 group-hover:scale-110 transition-transform">
                  <Mail className="w-6 h-6" />
                </div>
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Direct Email</p>
                <p className="text-sm font-bold text-slate-900 dark:text-white mt-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {PERSONAL_INFO.email}
                </p>
                <span className="mt-3 text-xs text-blue-600 dark:text-blue-400 font-medium">Send an email &rarr;</span>
              </a>

              {/* Phone & WhatsApp Card */}
              <div
                className="flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 shadow-sm hover:border-emerald-500/50 hover:shadow-md transition-all"
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
                  <a
                    href="https://wa.me/919924470299?text=Hello%20Ketan,%20reaching%20out%20via%20your%20portfolio"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-sm transition-all hover:scale-105"
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-semibold transition-all"
                    id="contact-link-call"
              ...
              >
                ...
                <span className="mt-3 text-xs text-blue-600 dark:text-blue-400 font-medium">Connect on LinkedIn &rarr;</span>
              </a>
            </div>

            {/* Response Time Guarantee */}
            <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200/60 dark:border-blue-800/60 text-xs text-blue-800 dark:text-blue-300 flex items-center justify-center gap-3 text-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-700/80 shadow-sm space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Phone & WhatsApp Card */}
                  <div
                    className="flex flex-col gap-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 hover:border-emerald-500/50 transition-all"
                    id="contact-sidebar-phone"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-slate-400">Phone & WhatsApp</p>
                    ...
                    <div className="flex items-center gap-2 pl-14">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-sm transition-all"
                        id="contact-sidebar-link-whatsapp"
                      >
                      ...
                      <a
                        href={`tel:${PERSONAL_INFO.phone}`}
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold transition-all"
                        id="contact-sidebar-link-call"
                      >
